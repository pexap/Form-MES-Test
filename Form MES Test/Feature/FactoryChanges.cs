...
namespace Form_MES_Test.Feature
{
    public class FactoryChanges
    {
        ...
        public FactoryChanges(TextBox _Log)
        {
            Log = _Log;
        ...
        public void FactoryAdd()
        {
            try
            {
                ...
                oCDO.ObjectChanges = new Camstar.WCF.ObjectStack.FactoryChanges { Name = "Factory 1", Description = "My First Factory" };
        ...
        public void FactoryUpdate()
        {
            try
            {
                ...
                oCDO.ObjectChanges = new Camstar.WCF.ObjectStack.FactoryChanges();
